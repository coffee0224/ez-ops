...
// where Q is [batch, num_heads, 1, head_dim]  (bfloat16)
//       K is [batch, num_heads, seq_len, head_dim]  (bfloat16)
//       V is [batch, num_heads, seq_len, head_dim]  (bfloat16)
//       out is [batch, num_heads, 1, head_dim]  (bfloat16)
